...
<div style="display:none;width:99.6%;height:auto;float:left;background-color:#eee;border-bottom:solid 1px #bbb;padding:2px;" id="filter_options">
...
<div class="tab" onmouseover="this.style.backgroundColor='#ddd';" onmouseout="this.style.backgroundColor=''" onclick="fetch_script('_codes/branches.php','settings');tab_item_change(4);$('#filter_options').slideUp('fast');$('#settings_title').attr('onclick','');" id="tab_4">Cluster settings</div>
...
<div class="tab" onmouseover="this.style.backgroundColor='#ddd';" onmouseout="this.style.backgroundColor='';" id="tab_8" onclick="fetch_script('_codes/about.php','settings');tab_item_change(8);$('#filter_options').slideUp('fast');$('#settings_title').attr('onclick','');">About PIPAT</div>
</div>
