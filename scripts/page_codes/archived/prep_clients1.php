...
<div style="width:100%;height:40px;float:left;line-height:40px;border-bottom:solid 1px #fff;">
	<div class="tab" style="color:#fff;border-right:solid 1px #ccc;background-color:#aaf;width:145px;height:40px;border-radius:20px 0px 0px 0px;" onmouseover="this.style.backgroundColor='#99f';" onmouseout="this.style.backgroundColor='#aaf'" id="tab_100" onclick="fetch_script('_codes/prep_dashboad.php?a=0','clients');$('#status_category_holder').slideUp('fast');$('#report_fetch_button').attr('onclick','fetch_dashboard($(\'#selected_dashboard\').val())');change_secondary_tabs(100);">Dashboards</div>

	<div class="tab" style="width:145px;border-right:solid 1px #ccc;background-color:#a15ec7;height:40px;" onmouseover="this.style.backgroundColor='#def';" onmouseout="this.style.backgroundColor='#aef'" id="tab_101" onclick="fetch_script('_codes/client_list.php?a=0','clients');$('#filter_options').slideUp('fast');$('#status_category_holder').slideDown('fast');$('#report_fetch_button').attr('onclick','fetch_client_list()');change_secondary_tabs(101);">PrEP client list</div>

	<div class="tab" style="width:145px;background-color:#a15ec7;height:40px;border-radius:0px 20px 0px 0px;" onmouseover="this.style.backgroundColor='#def';" onmouseout="this.style.backgroundColor='#aef'" id="tab_102" onclick="fetch_script('_codes/prep_reports.php?a=0','clients');$('#filter_options').slideUp('fast');$('#status_category_holder').slideUp('fast');$('#report_fetch_button').attr('onclick','fetch_report(0,0)');change_secondary_tabs(102);">Reports</div>
</div>
...
<div style="width:99.6%;height:auto;float:left;background-color:#eee;border-bottom:solid 1px #bbb;padding:2px;display:none;" id="filter_options">
	...
	<div style="width:850px;height:30px;margin:0 auto;margin-top:2px;margin-bottom:2px;">
