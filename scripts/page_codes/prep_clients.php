...
<div style="width:99.5%;min-height:400px;height:auto;float:left;padding:2px;">
...
<div style="width:100%;height:40px;float:left;line-height:40px;border-bottom:solid 1px #fff;">
	...
	<div class="tab" style="width:145px;border-right:solid 1px #ccc;background-color:#a15ec7;height:40px;" onmouseover="this.style.backgroundColor='#def';" onmouseout="this.style.backgroundColor='#aef'" id="tab_102" onclick="$('#dashboard_option_bar').slideUp('fast');fetch_script('_codes/prep_reports.php?a=0','clients');$('#filter_options').slideUp('fast');$('#status_category_holder').slideUp('fast');$('#report_fetch_button').attr('onclick','fetch_report(0,0)');change_secondary_tabs(102);" >Reports</div>

	<div class="tab" style="width:145px;background-color:#aef;height:40px;border-radius:0px 20px 0px 0px;" onmouseover="this.style.backgroundColor='#def';" onmouseout="this.style.backgroundColor='#aef'" id="tab_103" onclick="$('#dashboard_option_bar').slideUp('fast');fetch_script('_codes/prep_sites.php','clients');$('#filter_options').slideUp('fast');$('#status_category_holder').slideDown('fast');$('#report_fetch_button').attr('onclick','fetch_client_list()');change_secondary_tabs(103);">PrEP Site Locations</div>
</div>
...
<div class="option_item" title="Click to change option" onclick="$('#from_day_menu').toggle('fast');" id="active_from_day" onmouseover="this.style.backgroundColor='#ddd';" onmouseout="this.style.backgroundColor='#eee';"><?php print(date('j',time()));?></div>
...
<input type="hidden" id="date_from" value="<?php print(date('m/j/Y',time()));?>">
...
<input type="hidden" name="selected_from_day" id="selected_from_day" value="<?php print(date('j',time()));?>">
</div>
...
<?php
	for($y=(date('Y',time()));$y>(date('Y',time()) - 6);$y--){
		?>
