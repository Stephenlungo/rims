...
<input type="hidden" value="<?php print($module_id);?>" id ="module_id">
...
$questionnaires = mysqli_query($connect,"select * from prep_questionnaires where company_id = $company_id and module_id = $module_id $branch_search order by title")or die(mysqli_error($connect));
