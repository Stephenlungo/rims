<?php
	...
	if($dynamic_graph_id){
		...
		if(!$graph_type){
			$graph_type_title = 'pie';
			
		}else{
			$graph_type_title = 'Doughnut';
...
<input type="hidden" id="js_option_id_<?php print($dashboard_id.'_'.$dashboard_area_id);?>" value="0">
