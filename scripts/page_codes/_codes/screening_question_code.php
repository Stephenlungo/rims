...
if(!$end){
	...
	<div style="width:80%;margin:0 auto;height:auto;text-align:center;color:<?php print($result_color);?>" id="screen_result"></div>
	...
	<div style="width:80%;margin:0 auto;height:auto;text-align:center;display:none;" id="result_status"></div>
