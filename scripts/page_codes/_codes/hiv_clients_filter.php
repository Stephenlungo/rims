	<div style="width:350px;height:30px;margin:0 auto;margin-top:2px;margin-bottom:2px;">
		<input type="text" id="agent_search_key" value="Enter client name, ID or phone number" style="width:100%;height:30px;color:#aaa;text-align:center;" onfocus="if(this.value=='Enter client name, ID or phone number'){this.value='';this.style.color='#000';}" onfocusout="if(this.value==''){this.value='Enter client name, ID or phone number';this.style.color='#aaa';}" title="Enter client name, ID or phone number. You can search for multiple entries by separating each entry with a comma" onkeyup="if (event.keyCode == 13) {$('#tab_'+active_agent_tab).click();}">
	</div>
...
<div style="width:60px;height:30px;line-height:30px;float:left;">Region:</div>
	...
	<div style="width:auto;height:auto;float:left;" id="site_holder">
		...
		<div class="option_menu" id="site_menu" style="display:none;min-width:150px;max-width:280px;width:auto;">
			<?php			$location_menu = mysqli_query($connect,"select * from sites where company_id = $company_id $site_search order by title")or die(mysqli_error($connect));
	...
	</div>		<div style="width:auto;height:auto;float:left;" id="status_holder">		<div style="width:85px;height:30px;line-height:30px;float:left;">Risk status:</div>		<div style="width:auto;min-height:30px;height:auto;float:left;">					<div class="option_item" title="Click to change option" onclick="$('#status_menu').toggle('fast');" id="active_status" onmouseover="this.style.backgroundColor='#ddd';" onmouseout="this.style.backgroundColor='#eee';" style="min-width:110px;max-width:280px;width:auto;">All risks</div>		<div class="option_menu" id="status_menu" style="display:none;min-width:150px;max-width:280px;width:auto;">
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#status_menu').toggle('fast');$('#active_status').html($(this).html());$('#selected_status').val(0);">All risks</div>			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#status_menu').toggle('fast');$('#active_status').html($(this).html());$('#selected_status').val(1);">High risk</div>
			
				<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#status_menu').toggle('fast');$('#active_status').html($(this).html());$('#selected_status').val(2);">Medium risk</div>						<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#status_menu').toggle('fast');$('#active_status').html($(this).html());$('#selected_status').val(3);">Low risk</div>		</div></div>		<input type="hidden" id="selected_status" value="1">	</div>				<div style="width:auto;height:auto;float:left;" id="screening_method_holder">		<div style="width:115px;height:30px;line-height:30px;float:left;">Screening method:</div>		<div style="width:auto;min-height:30px;height:auto;float:left;">					<div class="option_item" title="Click to change option" onclick="$('#screening_method_menu').toggle('fast');" id="active_screening_method" onmouseover="this.style.backgroundColor='#ddd';" onmouseout="this.style.backgroundColor='#eee';" style="min-width:110px;max-width:280px;width:auto;">All clients</div>		<div class="option_menu" id="screening_method_menu" style="display:none;min-width:150px;max-width:280px;width:auto;">						<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#screening_method_menu').toggle('fast');$('#active_screening_method').html($(this).html());$('#selected_screening_method').val(0);">Self-screening USSD</div>						<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#screening_method_menu').toggle('fast');$('#active_screening_method').html($(this).html());$('#selected_screening_method').val(1);">Self-screening WhatsApp</div>						<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#screening_method_menu').toggle('fast');$('#active_screening_method').html($(this).html());$('#selected_screening_method').val(2);">Facility</div>		</div></div>		<input type="hidden" id="selected_screening_method" value="1">	</div>
	<div style="width:60px;height:30px;background-color:orange;color:#fff;text-align:center;line-height:30px;float:left;margin-right:5px;cursor:pointer;" onmouseover="this.style.backgroundColor='#ffc864';" onmouseout="this.style.backgroundColor='orange';"  id="report_fetch_button" onclick="fetch_covid_client_list(active_client_tab);" title="Click to fetch data">Fetch</div>