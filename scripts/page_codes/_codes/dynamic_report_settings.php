...
if($report_id){
	...
	$this_primary_column_type = mysqli_query($connect,"select * from dynamic_report_primary_column_types where id = $this_primary_column_type_id")or die(mysqli_error($connect));
	...
	$columns = mysqli_query($connect,"select * from dynamic_report_primary_columns where primary_column_type_id  = $this_primary_column_type_id")or die(mysqli_error($connect));
...
<div style="width:100%;height:auto;float:left;margin-bottom:10px;">
	<div style="width:300px;margin:0 auto;height:auto;">
		...
		<div class="option_menu" id="report_primary_column_menu" style="display:none;width:auto;width:120px;z-index:10">
			...
			<?php
			$dynamic_report_column_types = mysqli_query($connect,"select * from dynamic_report_primary_column_types where company_id = $company_id")or die(Mysqli_error($connect));
