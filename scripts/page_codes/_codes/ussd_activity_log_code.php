...
<input type="hidden" id="column_string_0_0" value="<?php print($column_string);?>">
<input type="hidden" id="row_string_0_0" value="<?php print($row_string);?>">
<input type="hidden" id="column_formating_string_0_0" value="<?php print($column_formating_string);?>">