...
<select id="basic_entry_day_0" onchange="if($('#basic_entry_day_0').val() >= <?php print(date('j',time()));?> && $('#basic_entry_month_0').val() == <?php print(date('m',time()));?> && $('#basic_entry_year_0').val() == <?php print(date('Y',time()));?>){alert('You cannot select a date for the future');this.value=<?php print(date('j',time()));?>}">
...
<select id="basic_entry_month_0" onchange="if($('#basic_entry_month_0').val() >= <?php print(date('m',time()));?> && $('#basic_entry_year_0').val() == <?php print(date('Y',time()));?>){alert('You cannot select a date for the future');this.value=<?php print(date('m',time()));?>}">
