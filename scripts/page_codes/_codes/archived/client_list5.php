...
<div style="width:auto;height:20px;float:left;line-height:20px;" id="detailed_list_status_bar"></div>
	...
	<div style="width:auto;height:auto;float:left;">
		...
		<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#quick_report_menu').toggle('fast');$('#selected_quick_report').val(0);$('#screening_rule_string').val('');$('#profile_rule_string').val('');$('#form_rule_string').val('');$('#screening_question_level_rule_string').val('');$('#form_category_level_rule_string').val('');alert('Upload in progress. Try again later');">SMS Report</div>
		
		<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#quick_report_menu').toggle('fast');$('#selected_quick_report').val(0);$('#screening_rule_string').val('');$('#profile_rule_string').val('');$('#form_rule_string').val('');$('#screening_question_level_rule_string').val('');$('#form_category_level_rule_string').val('');alert('Upload in progress. Try again later');">PrEP USSD Log</div>
			<?php
...
<div class="general_button" style="float:right;width:80px;height:20px;line-height:20px;background-color:#bbf;color:#fff;" onclick="$('#filter_options').slideUp('fast');fetch_client_details(0);" onmouseover="this.style.backgroundColor = '#ccf';" onmouseout="this.style.backgroundColor = '#bbf';" title="Click to add entry">New Client</div> <div class="general_button" style="float:right;width:220px;height:20px;line-height:20px;background-color:purple;color:#fff;" onclick="$('#filter_options').slideUp('fast');send_offline_pipat();" onmouseover="this.style.backgroundColor = '#b663b6';" onmouseout="this.style.backgroundColor = 'purple';" title="Click to Download offline version of the system" id="send_offline_pipat_button">Download Offline System Version</div><div class="general_button" style="float:right;width:120px;height:20px;line-height:20px;background-color:#25d4d8;color:#fff;display:none;" onclick="$('#checklists').slideToggle('fast');" onmouseover="this.style.backgroundColor = '#25bfc3';" onmouseout="this.style.backgroundColor = '#25d4d8';" title="Click to show or hide checklist docker">Check-List Dock</div>
...
<div style="width:180px;height:20px;float:left;margin-right:3px;">Names</div>
