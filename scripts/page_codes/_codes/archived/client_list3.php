...
<div style="width:auto;height:20px;float:left;line-height:20px;" id="detailed_list_status_bar"></div>
	...
	<div style="width:auto;height:auto;float:left;">
		...
		<div class="option_item" title="Click to change option" onclick="$('#quick_report_menu').toggle('fast');" id="client_export_button" onmouseover="this.style.backgroundColor = '#ccf';" onmouseout="this.style.backgroundColor = '#bbf';"  style="min-width:110px;max-width:270px;width:auto;background-color:#bbf;color:#fff;">Export</div>

		<div class="option_menu" id="quick_report_menu" style="display:none;width:auto;width:150px;">
...
<div class="general_button" style="float:right;width:80px;height:20px;line-height:20px;background-color:#bbf;color:#fff;" onclick="$('#filter_options').slideUp('fast');fetch_client_details(0);" onmouseover="this.style.backgroundColor = '#ccf';" onmouseout="this.style.backgroundColor = '#bbf';" title="Click to add entry">New Client</div> <div class="general_button" style="float:right;width:120px;height:20px;line-height:20px;background-color:#25d4d8;color:#fff;" onclick="$('#checklists').slideToggle('fast');" onmouseover="this.style.backgroundColor = '#25bfc3';" onmouseout="this.style.backgroundColor = '#25d4d8';" title="Click to show or hide checklist docker">Check-List Dock</div>
