...
$questionnaires = mysqli_query($connect,"select * from prep_questionnaires where company_id = $company_id and module_id = 5 $branch_search order by title")or die(mysqli_error($connect));
