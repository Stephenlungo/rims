...
$partitions = fetch_database_partitions(5,$today_start,$now);
$this_partition_name = $this_default_partition_name.'_partition_'.$partitions[0];

$this_client = mysqli_query($connect,"select * from $this_partition_name where id = $client_id")or die(mysqli_error($connect));
...
$population_category_id = $form_option_text[768];
	
if($population_category_id == ''){
...
$last_appointment_values = mysqli_query($connect,"select * from $this_partition_name where dynamic_form_category_option_id = 341 and client_id = $client_id order by _date desc")or die(mysqli_error($connect));

if(!mysqli_num_rows($last_appointment_values)){
	$last_initiation_values = mysqli_query($connect,"select * from $this_partition_name where dynamic_form_category_option_id = 340 and client_id = $client_id order by _date desc")or die(mysqli_error($connect));
...
<div style="width:140px;height:30px;line-height:30px;float:left;font-weight:bold;">Population category:</div>
<div style="width:230px;min-height:30px;height:auto;float:left;line-height:30px;">

<div class="option_item" title="Click to change option" onclick="$('#follow_up_population_category_menu').toggle('fast');" id="active_follow_up_population_category" onmouseover="this.style.backgroundColor='#ddd';" onmouseout="this.style.backgroundColor='#eee';" style="min-width:110px;max-width:280px;width:auto;"><?php print($population_category_title);?></div>

		<div class="option_menu" id="follow_up_population_category_menu" style="display:none;min-width:150px;max-width:280px;width:auto;">
		
		<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(6);">Police Officer</div>
		
		<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(7);">Inmates</div>
		
		<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(8);">Prison Officer</div>
		
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(0);">General</div>
			
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(9);">Young Males</div>
			
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(1);">MSM</div>
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(2);">DC</div>
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(3);">FSW</div>
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(4);">PLM</div>
			
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(10);">TG</div>
			
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(5);">AG/YW</div>
			
			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#follow_up_population_category_menu').toggle('fast');$('#active_follow_up_population_category').html($(this).html());$('#option_768_text').val(11);">PWID</div>
			
		
		</div>
	</div>
	<input type="hidden" id="option_768" value="1">
	<input type="hidden" id="option_768_text" value="<?php print($population_category_id);?>">
</div>
...
<div style="width:100%;min-height:20px;height:auto;line-height:20px;float:left;"><input type="radio" name="prep_dispensed" id="field_314" <?php print($form_option_checked[314]);?> onclick="check_prep_dispensed_2(314)"><label for="field_314">1 Month</label><input type="radio" name="prep_dispensed" id="field_316" <?php print($form_option_checked[316]);?> onclick="check_prep_dispensed_2(316)"><label for="field_316">2 Months</label><input type="radio" name="prep_dispensed" id="field_317" <?php print($form_option_checked[317]);?> onclick="check_prep_dispensed_2(317)"><label for="field_317">3 Months</label><input type="radio" name="prep_dispensed" id="field_767" <?php print($form_option_checked[767]);?> onclick="check_prep_dispensed_2(767)"><label for="field_767">6 Months</label></div>
...
<input type="hidden" id="option_767" value="<?php print($form_option_value[767]);?>">
...
if($form_option_value[320] == ''){
	...
	$clinical_day = 'Select';
	$clinical_month = 'Select';
	$clinical_year = 'Select';
...
if($form_option_value[320] == ''){
	...
	$pharmacy_day = 'Select';
	$pharmacy_month = 'Select';
	$pharmacy_year = 'Select';
...
<script>
	function check_prep_dispensed_2(field_id){
		$('#option_314').val('');
		$('#option_316').val('');
		$('#option_317').val('');
		$('#option_336').val('');
		...
		var initiation_value = $('#option_341').val();
		if($('#follow_up_date_validated').val() == 0){
			$('#follow_up_clinical_date_validation').val(0);
			$('#follow_up_pharmacy_date_validation').val(0);
			
			$('#active_clinical_follow_up_day').html('Select');
			$('#active_clinical_follow_up_month').html('Select');
			$('#active_clinical_follow_up_year').html('Select');
			
			$('#selected_clinical_follow_up_day').val(0);
			$('#selected_clinical_follow_up_month').val(0);
			$('#selected_clinical_follow_up_year').val(0);
			
			$('#active_pharmacy_follow_up_day').html('Select');
			$('#active_pharmacy_follow_up_month').html('Select');
			$('#active_pharmacy_follow_up_year').html('Select');
			
			$('#selected_pharmacy_follow_up_day').val(0);
			$('#selected_pharmacy_follow_up_month').val(0);
			$('#selected_pharmacy_follow_up_year').val(0);
			...
			var initiation_date = new Date(initiation_value_array[2]+'/'+initiation_value_array[0]+'/'+initiation_value_array[1]+' 00:00:00');
			
			var initiation_timestamp = initiation_date.getTime();
			
			if(field_id == 336){
				var multiplier = 14;
				
			}else if(field_id == 314 || field_id == 316 || field_id == 317 || field_id == 767){
				if(field_id == 314){
					var multiplier = 30;
				...
				}else if(field_id == 767){
					var multiplier = 180;
					
				}
			}
			
			var new_timestamp = initiation_timestamp+(86400000 * multiplier);
			var this_date = new Date(new_timestamp);			
			
			if(this_date.getDay() == 0){
				new_timestamp = (new_timestamp - 172800000);
				var this_date = new Date(new_timestamp);
				
			}else if(this_date.getDay() == 6){
				new_timestamp = (new_timestamp - 86400000);
				var this_date = new Date(new_timestamp);
				
			}
			
			clinical_day = this_date.getDate();
			clinical_month = this_date.getMonth()+1;
			clinical_year = this_date.getFullYear();
...
<div style="line-height:30px;width:37px;height:30px;float:left;margin-left:5px;">Month:</div>
<div style="width:40px;min-height:30px;height:auto;float:left;position:relative;z-index:50">
...
<div style="line-height:30px;width:30px;height:30px;float:left;margin-left:5px;">Year:</div>
<div style="width:40px;min-height:30px;height:auto;float:left;position:relative;z-index:50">
...
<?php
	for($y=(date('Y',time())+1);$y>(date('Y',time()) - 3);$y--){
		?>
...
function check_if_pharmacy_future(){
	...
	if(!isNaN(date_array[1])){
		if(date_array[0]){
			...
			if(date_array[1] < -15552000){
				$('#follow_up_pharmacy_date_validation_status').html('Pharmacy date cannot be after 6 months');
				$('#follow_up_pharmacy_date_validation_status').css('color','red');
				$('#follow_up_pharmacy_date_validation_status').slideDown('fast');
				$('#follow_up_pharmacy_date_holder').css('border','solid 1px red');
				$('#follow_up_pharmacy_date_validation').val(0);
...
function check_if_clinical_future(){
	...
	if(!isNaN(date_array[1])){
		if(date_array[0]){
			...
			if(date_array[1] < -15552000){
				$('#follow_up_clinical_date_validation_status').html('Clinical date cannot be after 6 months');
				$('#follow_up_clinical_date_validation_status').css('color','red');
				$('#follow_up_clinical_date_validation_status').slideDown('fast');
				$('#follow_up_clinical_date_holder').css('border','solid 1px red');
				$('#follow_up_clinical_date_validation').val(0);
