<div style="width:350px;height:30px;margin:0 auto;margin-top:2px;margin-bottom:2px;">
		<input type="text" id="search_key_string" value="Enter folder name" style="width:100%;height:30px;color:#aaa;text-align:center;" onfocus="if(this.value=='Enter folder name'){this.value='';this.style.color='#000';}" onfocusout="if(this.value==''){this.value='Enter folder name';this.style.color='#aaa';}" title="Enter folder name. You can search for multiple entries by separating each entry with a comma" onkeyup="if (event.keyCode == 13) {fetch_payment_folders();}">
...
<div style="width:60px;height:30px;line-height:30px;float:left;">Region:</div>
	...
	<div style="width:auto;height:auto;float:left;">
		<div style="min-width:40px;width:auto;height:30px;line-height:30px;float:left;">Accessibility:</div>
		<div style="width:auto;min-height:30px;height:auto;float:left;margin-left:5px;">
			<div class="option_item" title="Click to change option" onclick="$('#accessibility_menu').toggle('fast');" id="active_accessibility" onmouseover="this.style.backgroundColor='#ddd';" onmouseout="this.style.backgroundColor='#eee';" style="min-width:110px;max-width:280px;width:auto;">All folders</div>
			
			<div class="option_menu" id="accessibility_menu" style="display:none;min-width:150px;max-width:280px;width:auto;">
				<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#accessibility_menu').toggle('fast');$('#active_accessibility').html($(this).html());$('#selected_accessibility').val('0');">All folders</div>
				
				<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#accessibility_menu').toggle('fast');$('#active_accessibility').html($(this).html());$('#selected_accessibility').val(1);">Only accessibility to everyone</div>
				
				<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#accessibility_menu').toggle('fast');$('#active_accessibility').html($(this).html());$('#selected_accessibility').val(2);">Only accessibility to me</div>
			</div>
		</div>
		<input type="hidden" id="selected_accessibility" value="0">
	</div>
	
	
	<div style="width:auto;height:auto;float:left;">
		<div style="min-width:40px;width:auto;height:30px;line-height:30px;float:left;">Status:</div>
		<div style="width:auto;min-height:30px;height:auto;float:left;margin-left:5px;">
			<div class="option_item" title="Click to change option" onclick="$('#status_menu').toggle('fast');" id="active_status" onmouseover="this.style.backgroundColor='#ddd';" onmouseout="this.style.backgroundColor='#eee';" style="min-width:110px;max-width:280px;width:auto;">Active</div>
			
			<div class="option_menu" id="status_menu" style="display:none;min-width:150px;max-width:280px;width:auto;">
				<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#status_menu').toggle('fast');$('#active_status').html($(this).html());$('#selected_status').val('0');">All folders</div>
				
				<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#status_menu').toggle('fast');$('#active_status').html($(this).html());$('#selected_status').val(1);">Active</div>
				
				<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#status_menu').toggle('fast');$('#active_status').html($(this).html());$('#selected_status').val(2);">Inactive</div>
			</div>
		</div>
	...
	<div style="width:60px;height:30px;background-color:orange;color:#fff;text-align:center;line-height:30px;float:left;margin-right:5px;cursor:pointer;" onmouseover="this.style.backgroundColor='#ffc864';" onmouseout="this.style.backgroundColor='orange';"  id="report_fetch_button" onclick="fetch_payment_folders()" title="Click to fetch report with specified options">Fetch</div>