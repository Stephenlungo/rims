...
function create_or_update_custom_client_form(form_id,data_set_id){
	...
	if(form_id == 2){
		if($('#option_109').val() == '' && $('#option_110').val() == '' && $('#option_111').val() == ''){
	...
	if(form_validation_successful){
		...
		if(c){
			...
			data.append('data_set_id',data_set_id);
			data.append('client_id',$('#client_id').val());
			data.append('form_option_string',$('#form_option_string').val());
			data.append('form_option_type_string',$('#form_option_type_string').val());
			
			var option_id_string = $('#form_option_string').val();
			var option_type_string = $('#form_option_type_string').val();
			...
			if(form_validation_successful){
				...
				$('#dynamic_form_save_button').html('Wait...');
			}
		}
	}
}
