...
module_xmlhttp.onreadystatechange = function(){
	if(module_xmlhttp.readyState == 4 && module_xmlhttp.status == 200){
		...
		}else if(response_array[0] == 'fetch_claim_details' || response_array[0] == 'allocate_claims'){
			display_infor('item_details_holder',response_array[1]);
		...
		}else if(esponse_array[0] == 'fetch_edit_beneficiary_data'){
			var claim_date = esponse_array[1];
			var claim_type_date = esponse_array[2];
			var agent_date = esponse_array[3];
			
			var agent_id = esponse_array[4];
			var agent_name = esponse_array[5];
			var agent_nrc = esponse_array[6];
			var agent_phone = esponse_array[7];
...
function fetch_edit_beneficiary_data(claim_date,claim_type_date,agent_date){
	...
	data.eppend('fetch_edit_beneficiary_data',1);
	data.append('claim_date',claim_date);
	data.append('claim_type_date',claim_type_date);
	data.append('agent_date',agent_date);
