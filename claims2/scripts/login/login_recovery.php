...
<div style="width:100%;height:30px;float:left;"><input onfocus="this.type='password';if(this.value=='Enter your new password'){this.value='';this.style.color='#000';}this.style.borderColor='#aaa';document.getElementById('errorMsg').value='';" onfocusout="if(this.value==''){this.type='text';this.value='Enter your new password';this.style.color='#aaa';}" style="border:solid 1px #aaa;color:#aaa;height:30px;width:100%;" type="text" id="reset_password" value="Enter your new password"></div>
</div>
...
<div style="width:100%;height:30px;float:left;"><input onfocus="this.type='password';if(this.value=='Re-enter your new password'){this.value='';this.style.color='#000';}this.style.borderColor='#aaa';document.getElementById('errorMsg').value='';" onfocusout="if(this.value==''){this.type='text';this.value='Re-enter your new password';this.style.color='#aaa';}" style="border:solid 1px #aaa;color:#aaa;height:30px;width:100%;" type="text" id="reset_password2" value="Re-enter your new password"></div>
</div>
