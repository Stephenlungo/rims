...
<div class="header" id="header_2" style="display:none;position:fixed;height:40px;background-color:#006bb3;color:#fff;">
<div class="logo">
<div class="logo_image"><img src="<?php print($system_logo);?>" height="100%" width="100%"></div>
...
<?php
$areas = mysqli_query($connect,"select * from areas where publishStatus = 1 order by _order")or die(mysqli_error($connect));
?>
