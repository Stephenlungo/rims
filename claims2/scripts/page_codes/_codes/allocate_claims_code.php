	<div style="width:100%;height:30px;float:left;margin-top:10px;">Number of claims to allocate: <?php print(count($selected_claims));?></div>
	<div style="width:110px;height:30px;line-height:30px;float:left;color:#006bb3">Allocation level:</div>		<div style="width:auto;min-height:30px;height:auto;float:left;">		<div class="option_item" title="Click to change option" onclick="$('#allocation_level_menu').toggle('fast');" id="active_allocation_level" onmouseover="this.style.backgroundColor='#ddd';" onmouseout="this.style.backgroundColor='#eee';" style="min-width:110px;max-width:280px;width:auto;">Level 3</div>				<div class="option_menu" id="allocation_level_menu" style="display:none;min-width:150px;max-width:280px;width:auto;">			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#allocation_level_menu').toggle('fast');$('#active_allocation_level').html($(this).html());$('#selected_allocation_level').val(0);">Level 1</div>			<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#allocation_level_menu').toggle('fast');$('#active_allocation_level').html($(this).html());$('#selected_allocation_level').val(1);">Level 2</div>						<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#allocation_level_menu').toggle('fast');$('#active_allocation_level').html($(this).html());$('#selected_allocation_level').val(2);">Level 3</div>						<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#allocation_level_menu').toggle('fast');$('#active_allocation_level').html($(this).html());$('#selected_allocation_level').val(3);">Level 4</div>						<div class="option_menu_item" onmouseover="this.style.color='#006bb3';" onmouseout="this.style.color='#000';" onclick="$('#allocation_level_menu').toggle('fast');$('#active_allocation_level').html($(this).html());$('#selected_allocation_level').val(4);">Level 5</div>		</div>			</div>		<input type="hidden" id="selected_allocation_level" value="2">		
