					...
					if($beneficiary_type_date_array[$b] == $this_claim_type_date){
						...
						if(isset($other_beneficiary_set_index[0])){
							...
							for($ob=0;$ob<count($other_beneficiary_set_index);$ob++){
								...
								if(isset($this_other_claim_set_index[0])){
